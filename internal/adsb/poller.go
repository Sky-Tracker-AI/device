...
func (mp *MockPoller) generateMockFleet() []mockAircraft {
	fleet := []struct {
		...
		{"A2F3G4", "DAL88", 33000, 39000, 480},
		{"A3H4I5", "AAL2201", 25000, 37000, 460},
		{"A4J5K6", "JBU614", 29000, 36000, 440},
		{"A5L6M7", "N172SP", 2500, 5500, 110},
		{"A6N7O8", "SKW5432", 18000, 28000, 380},
		{"A7P8Q9", "FDX1021", 34000, 41000, 490},
		{"A8R9S0", "N524JT", 8000, 12000, 180},
		{"A9T0U1", "ASA331", 31000, 37000, 460},
		{"B0V1W2", "FFT402", 15000, 22000, 320},
		{"B1X2Y3", "NKS917", 27000, 35000, 440},
		{"B2Z3A4", "EVAC01", 16000, 20000, 350},
